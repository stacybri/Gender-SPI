...
```{r saver, eval=FALSE, include=FALSE, show_col_types = FALSE}
...
table1_df <- disagg_tab_df %>%
  ...
  mutate(`Sex Disaggregation Available`=if_else(is.na(`Any Data Available`),0,`Sex Disaggregation Available`),
